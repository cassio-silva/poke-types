...
export function PokecoinControls() {
  ...
  return (
    <form className='flex flex-col items-center justify-center gap-4' onSubmit={handleSubmitCalculation}>
      ...
      <div className="flex w-fit items-center justify-center gap-4">
        <button className="w-28 h-28 lg:w-32 lg:h-32 transition filter bg-yellow-400 rounded-full shadow-yellow-100 hover:animate-glow " type='submit'>
          <Image
            width={200}
            height={200}
